<div class="flex flex-col items-center justify-center gap-2 md:gap-4 m-10">
    ...
    <div class="app-main-content">
        <a href="{{ route('test') }}">
            <div
                class="bg-slate-900 p-4 md:p-10 rounded-xl md:rounded-3xl text-xl md:text-4xl hover:bg-slate-800 hover:scale-110 motion-safe:animate-pulse solve-now-btn cursor-pointer">
                Solve Now
            </div>
        </a>
